...
export const allPhrases = {
  ...
  unit2: {
    ...
    chapter3: {
      ...
      lesson2: [
        { foreign: 'U pravu si!', english: 'You’re right! (Informal singular)' },
        { foreign: 'Nosit ću sanDAle za sada.', english: 'I will wear sandals for now.' },
      ...
      lesson4: [
        ...
        { foreign: 'Oprat ću odjeću.', english: 'I’ll wash the clothes.' },
        { foreign: 'odjeću', english: 'clothes' },
      ],
    },
  },
};
