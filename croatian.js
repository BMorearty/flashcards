...
export const allPhrases = {
  custom: {
    ...
    chapter3: {
      ...
      lesson1: [
        { foreign: 'Bok.', english: 'Hi. / Bye.' },
        { foreign: 'Trebam pomoć.', english: 'I need help.', hard: true },
        { foreign: 'Dobra večer.', english: 'Good evening.' },
      ],
    },
    chapter4: {
      name: 'Vocabulary',
  ...
  unit1: {
    chapter1: {
      ...
      lesson1: [
        ...
        { foreign: 'Dobro. A Vi?', english: 'Fine. And you? (Formal singular)', working_on: true },
      ...
      lesson2: [
        ...
        { foreign: 'Drago mi je', english: 'Nice to meet you', hard: true, working_on: true },
    ...
    chapter2: {
      ...
      lesson3: [
        { foreign: 'otac', english: 'father', working_on: true },
        { foreign: 'majka', english: 'mother', working_on: true },
      ...
      lesson4: [
        ...
        { foreign: 'roditelji', english: 'parents', working_on: true },
  ...
  unit2: {
    chapter1: {
      ...
      lesson3: [
        ...
        { foreign: 'pravi', english: 'real / true / proper / right', hard: true },
  ...
  unit4: {
    ...
    chapter5: {
      ...
      lesson2: [
        {
          foreign: 'Ne, ali moj auto blokira promet.',
          english: 'No, but my car is blocking traffic.',
        },
        { foreign: 'auto, autoMObil', english: 'car' },
        {
        ...
        { foreign: 'vozilo hitne pomoći', english: 'ambulance', hard: true },
        { foreign: 'vozilo', english: 'vehicle' },
      ],
      lesson3: [
        { foreign: 'Moj auto se pokVArio.', english: 'My car is broken.' },
        { foreign: 'Koja je aDREsa?', english: 'What is the address?' },
        { foreign: 'aDREsa', english: 'address' },
        { foreign: 'parKIralište', english: 'parking lot' },
      ],
      lesson4: [
        { foreign: 'tko', english: 'who' },
        { foreign: 'pronaći', english: 'to find' },
        { foreign: 'puknuta guma', english: 'flat tire', hard: true },
        { foreign: 'Treba mi liječnik.', english: 'I need a doctor.' },
        { foreign: 'trebati', english: 'to need' },
