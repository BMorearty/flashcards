...
export const allPhrases = {
  ...
  unit3: {
    ...
    chapter3: {
      ...
      lesson3: [
        { foreign: 'poNEdjeljak / u poNEdjeljak', english: 'Monday / on Monday' },
        { foreign: 'utorak / u utorak', english: 'Tuesday / on Tuesday' },
        { foreign: 'sriJEda / u sriJEdu', english: 'Wednesday / on Wednesday' },
        { foreign: 'četVRtak / u četvrtak', english: 'Thursday / on Thursday' },
        { foreign: 'Idem plesati.', english: 'I’m going to dance.' },
