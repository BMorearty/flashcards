  ...
  custom: {
    ...
    chapter11: {
      ...
      lesson1: [
        ...
        { foreign: 'árabe', english: 'Arab (adj.)', working_on: true },
        { foreign: 'argentino / argentina', english: 'Argentinian (adj.)', working_on: true },
        { foreign: 'australiano / australiana', english: 'Australian (adj.)' },
        { foreign: 'boliviano / boliviana', english: 'Bolivian (adj.)', working_on: true },
        { foreign: 'brasileño / brasileña', english: 'Brazilian (adj.)', working_on: true },
        { foreign: 'chileno / chilena', english: 'Chilean (adj.)', working_on: true, hard: true },
        { foreign: 'chino / china', english: 'Chinese (adj.)' },
        { foreign: 'colombiano / colombiana', english: 'Colombian (adj.)', working_on: true },
        {
          foreign: 'costarricense (kohstahrreeSEHNseh)',
          english: 'Costa Rican (adj.)',
          working_on: true,
        },
        { foreign: 'cubano / cubana', english: 'Cuban (adj.)', working_on: true },
        { foreign: 'ecuatoriano / ecuatoriana', english: 'Ecuadorean (adj.)', working_on: true },
        {
        ...
        { foreign: 'español / española', english: 'Spanish (adj.)', working_on: true },
        {
          foreign: 'europeo / europea (ehwrohPEHoh /ehwrohPEHah)',
          english: 'European (adj.)',
          working_on: true,
        },
        { foreign: 'británico / británica', english: 'British (adj.)', working_on: true },
        {
          foreign: 'guatemalteco / guatemalteca (gwahtehmahlTEHkoh / gwahtehmahlTEHkah)',
          english: 'Guatemalan (adj.)',
          working_on: true,
        },
        { foreign: 'hondureño / hondureña', english: 'Honduran (adj.)', working_on: true },
        { foreign: 'japonés / japonesa', english: 'Japanese (adj.)', working_on: true },
        { foreign: 'nicaragüense', english: 'Nicaraguan (adj.)', working_on: true, hard: true },
        {
        ...
        { foreign: 'peruano / peruana', english: 'Peruvian (adj.)', working_on: true, hard: true },
        { foreign: 'portugués / portuguesa', english: 'Portuguese (adj.)', working_on: true },
        {
        ...
        { foreign: 'ruso / rusa', english: 'Russian (adj.)', working_on: true },
        { foreign: 'turco / turca', english: 'Turkish (adj.)' },
        { foreign: 'uruguayo / uruguaya', english: 'Uruguayan (adj.)', working_on: true },
        { foreign: 'venezolano / venezolana', english: 'Venezuelan (adj.)', working_on: true },
        { foreign: 'maltés / maltesa', english: 'Maltese (adj.)', working_on: true },
        { foreign: 'irlandés / irlandesa', english: 'Irish (adj.)', working_on: true, hard: true },
        { foreign: 'alemán / alemana', english: 'German (adj.)', working_on: true },
        { foreign: 'francés / francesa', english: 'French (adj.)', working_on: true },
      ],
    },
  },
  genders: {
  ...
  unit1: {
    ...
    chapter2: {
      ...
      lesson7: [
        ...
        { foreign: 'la clase', english: 'the class', working_on: true },
        { foreign: 'con fluidez', english: 'fluently', working_on: true, hard: true },
      ],
    },
  },
};
