  ...
  custom: {
    chapter1: {
      ...
      lesson1: [
        ...
        { foreign: 'sin embargo', english: 'however', hard: true, workingOn: true },
        { foreign: 'ambos / ambas', english: 'both', hard: true, workingOn: true },
        {
          foreign: 'entonces',
      ...
      lesson2: [
        ...
        { foreign: 'Más o menos.', english: 'So-so.', workingOn: true, showEnglish: false },
        { foreign: 'aburrido', english: 'bored', workingOn: true },
        { foreign: 'contento', english: 'glad' },
        { foreign: 'enojado', english: 'angry', workingOn: true, hard: true },
        ...
        { foreign: '¡Cuídate!', english: 'Take care! (informal)', workingOn: true, hard: true },
      ...
      lesson5: [
        ...
        { foreign: 'mismo / misma', english: 'same', workingOn: true },
        { foreign: 'ahorita', english: 'right now' },
      ],
      lesson6: [
        { foreign: 'afuera', english: 'outside', workingOn: true, hard: true },
        { foreign: 'adentro', english: 'inside', workingOn: true, hard: true },
        ...
        { foreign: 'desayunar', english: 'to have breakfast', workingOn: true, hard: true },
        { foreign: 'Estoy desayunando.', english: 'I’m having breakfast.', workingOn: true },
        {
        ...
        { foreign: 'árbol', english: 'tree', workingOn: true },
        { foreign: 'ventana', english: 'window', workingOn: true },
        {
    ...
    chapter3: {
      ...
      lesson1: [
        ...
        { foreign: 'Está seco.', english: 'It is dry.', workingOn: true },
        { foreign: 'Está soleado.', english: 'It is sunny.' },
        { foreign: 'Está ventoso.', english: 'It is windy.', hard: true, workingOn: true },
    ...
    chapter4: {
      ...
      lesson1: [
        { foreign: 'la llave', english: 'the key', workingOn: true },
        { foreign: 'la yegua', english: 'the mare', hard: true },
        { foreign: 'la gallina', english: 'the hen', hard: true, workingOn: true },
      ...
      lesson2: [
        { foreign: 'la bañera', english: 'the bathtub', hard: true, workingOn: true },
        { foreign: 'el vestido', english: 'the dress', hard: true, workingOn: true },
        { foreign: 'el virus', english: 'the virus' },
        { foreign: 'la botella', english: 'the bottle' },
        { foreign: 'la bufanda', english: 'the scarf', workingOn: true },
        { foreign: 'la vaca', english: 'the cow', hard: true, workingOn: true },
      ...
      lesson3: [
        ...
        { foreign: 'el conejo', english: 'the rabbit', hard: true, workingOn: true },
        { foreign: 'la cuchara', english: 'the spoon', workingOn: true },
        { foreign: 'el kárate', english: 'the karate' },
        { foreign: 'la mantequilla', english: 'the butter', workingOn: true },
      ],
      lesson4: [
        { foreign: 'el zapato', english: 'the shoe', workingOn: true },
        { foreign: 'el cepillo', english: 'the brush', hard: true, workingOn: true },
        { foreign: 'el semáforo', english: 'the traffic light', workingOn: true },
        { foreign: 'el zinc', english: 'the zinc' },
        { foreign: 'el cine', english: 'the cinema' },
        { foreign: 'la silla', english: 'the chair', hard: true, workingOn: true },
        { foreign: 'el zorro', english: 'the fox', workingOn: true },
      ],
      lesson5: [
        { foreign: 'el jabón', english: 'the soap', hard: true, workingOn: true },
      ...
      lesson6: [
        ...
        { foreign: 'el guepardo', english: 'the cheetah', hard: true, workingOn: true },
        { foreign: 'la hamburguesa', english: 'the hamburger' },
        { foreign: 'la guitarra', english: 'the guitar' },
        { foreign: 'el águila', english: 'the eagle', hard: true, workingOn: true },
        { foreign: 'la gorra', english: 'the cap', workingOn: true },
        { foreign: 'el gusano', english: 'the worm', hard: true },
      ],
      lesson7: [
        { foreign: 'el hacha', english: 'the axe', workingOn: true },
    ...
    chapter8: {
      ...
      lesson1: [
        ...
        { foreign: 'Estoy cenando.', english: 'I am having dinner.', hard: true, workingOn: true },
        ...
        { foreign: 'Estoy acostandome.', english: 'I am going to bed.', workingOn: true },
    ...
    chapter10: {
      ...
      lesson1: [
        ...
        { foreign: 'La niña tiene un gato.', english: 'The girl has a cat.', workingOn: true },
        {
        ...
        { foreign: 'Tiene que ir.', english: 'He has to go.', workingOn: true },
        { foreign: 'Yo he hecho mi trabajo.', english: 'I have done my job.', workingOn: true },
        {
    ...
    chapter11: {
      name: 'Nationalities and origins',
      lesson1: [
        { foreign: 'nacionalidad', english: 'nationality' },
        { foreign: 'árabe', english: 'Arab (adj.)', workingOn: true },
        { foreign: 'argentino / argentina', english: 'Argentinian (adj.)', workingOn: true },
        { foreign: 'australiano / australiana', english: 'Australian (adj.)' },
        { foreign: 'boliviano / boliviana', english: 'Bolivian (adj.)', workingOn: true },
        { foreign: 'brasileño / brasileña', english: 'Brazilian (adj.)', workingOn: true },
        { foreign: 'chileno / chilena', english: 'Chilean (adj.)', workingOn: true, hard: true },
        { foreign: 'chino / china', english: 'Chinese (adj.)' },
        { foreign: 'colombiano / colombiana', english: 'Colombian (adj.)', workingOn: true },
        {
          foreign: 'costarricense (kohstahrreeSEHNseh)',
          english: 'Costa Rican (adj.)',
          workingOn: true,
        },
        { foreign: 'cubano / cubana', english: 'Cuban (adj.)', workingOn: true },
        { foreign: 'ecuatoriano / ecuatoriana', english: 'Ecuadorean (adj.)', workingOn: true },
        {
        ...
        { foreign: 'español / española', english: 'Spanish (adj.)', workingOn: true },
        {
          foreign: 'europeo / europea (ehwrohPEHoh /ehwrohPEHah)',
          english: 'European (adj.)',
          workingOn: true,
        },
        { foreign: 'británico / británica', english: 'British (adj.)', workingOn: true },
        {
        ...
        { foreign: 'hondureño / hondureña', english: 'Honduran (adj.)', workingOn: true },
        { foreign: 'japonés / japonesa', english: 'Japanese (adj.)', workingOn: true },
        { foreign: 'nicaragüense', english: 'Nicaraguan (adj.)', workingOn: true, hard: true },
        {
        ...
        { foreign: 'peruano / peruana', english: 'Peruvian (adj.)', workingOn: true, hard: true },
        { foreign: 'portugués / portuguesa', english: 'Portuguese (adj.)', workingOn: true },
        {
        ...
        { foreign: 'ruso / rusa', english: 'Russian (adj.)', workingOn: true },
        { foreign: 'turco / turca', english: 'Turkish (adj.)' },
        { foreign: 'uruguayo / uruguaya', english: 'Uruguayan (adj.)', workingOn: true },
        { foreign: 'venezolano / venezolana', english: 'Venezuelan (adj.)', workingOn: true },
        { foreign: 'maltés / maltesa', english: 'Maltese (adj.)', workingOn: true },
        { foreign: 'irlandés / irlandesa', english: 'Irish (adj.)', workingOn: true, hard: true },
        { foreign: 'alemán / alemana', english: 'German (adj.)', workingOn: true },
        { foreign: 'francés / francesa', english: 'French (adj.)', workingOn: true },
      ],
    },
  },
  genders: {
    ...
    chapter2: {
      ...
      lesson1: [
        ...
        { foreign: 'la amistad', english: 'the friendship', workingOn: true },
        { foreign: 'la pared', english: 'the wall' },
        { foreign: 'la salud', english: 'the health' },
        { foreign: 'la canción', english: 'the song', hard: true, workingOn: true },
        ...
        { foreign: 'el titular', english: 'the owner', hard: true, workingOn: true },
        { foreign: 'el computador/la computadora', english: 'the computer' },
        { foreign: 'el taller', english: 'the shop', hard: true, workingOn: true },
        ...
        { foreign: 'la ley', english: 'the law', hard: true, workingOn: true },
        ...
        { foreign: 'el campo', english: 'the field', hard: true, workingOn: true },
  ...
  unit1: {
    ...
    chapter1: {
      ...
      lesson2: [
        ...
        { foreign: '¿Cómo está él?', english: 'How is he?', hard: true, workingOn: true },
      ],
      lesson3: [
    ...
    chapter2: {
      ...
      lesson3: [
        ...
        { foreign: '¿De dónde es?', english: 'Where is she from?', workingOn: true },
      ],
      lesson4: [
        {
        ...
        { foreign: 'Son mexicanos.', english: 'They are Mexican.', hard: true, workingOn: true },
      ],
      lesson5: [
      ...
      lesson7: [
        ...
        { foreign: 'la clase', english: 'the class', workingOn: true },
