  ...
  custom: {
    chapter1: {
      ...
      lesson7: [
        ...
        { foreign: 'cuñado', english: 'brother-in-law', workingOn: true, hard: true },
    ...
    chapter23: {
      ...
      lesson3: [
        ...
        { foreign: 'jardín', english: 'garden', workingOn: true },
        { foreign: 'la pizarra', english: 'the chalkboard', workingOn: true },
        { foreign: 'el pizarrón', english: 'the blackboard or whiteboard', workingOn: true },
        { foreign: 'bolígrafo', english: 'pen', workingOn: true },
        { foreign: 'camiseta', english: 't-shirt', workingOn: true },
        { foreign: 'un jersey', english: 'a sweater', workingOn: true },
        { foreign: 'un pantalón azul', english: 'a pair of blue pants', workingOn: true },
        {
          foreign: 'Está al lado de la ventana.',
          english: 'He is next to the window.',
          workingOn: true,
        },
        { foreign: 'No veo a Javier.', english: 'I don’t see Javier.', workingOn: true },
      ],
      lesson4: [
        { foreign: 'me pregunto', english: 'I wonder', workingOn: true },
        { foreign: 'mesclo', english: 'mix', workingOn: true },
        { foreign: 'Me mareo.', english: 'I feel dizzy.', workingOn: true },
        { foreign: 'Me mareo en el mar.', english: 'I get seasick.', workingOn: true },
        { foreign: 'mareado / mareada', english: 'seasick / dizzy', workingOn: true },
        { foreign: 'Me mareo con el mar.', english: 'I get seasick.', workingOn: true },
        { foreign: 'un crucero en un rio', english: 'a river cruise', workingOn: true },
        { foreign: 'tronco / torso', english: 'torso', workingOn: true },
        { foreign: 'agarrar', english: 'to grab', workingOn: true },
        { foreign: 'guantes', english: 'gloves', workingOn: true },
        { foreign: 'calcetinas', english: 'socks', workingOn: true },
        {
          foreign: 'Estás caminando muy raro.',
          english: 'You are walking very weirdly.',
          workingOn: true,
        },
        { foreign: 'todo el mundo / todo', english: 'everyone', workingOn: true },
        { foreign: 'pastillas', english: 'pills', workingOn: true },
        { foreign: 'hidroavión', english: 'seaplane', workingOn: true },
        { foreign: 'orca', english: 'orca', workingOn: true },
    ...
    chapter24: {
      ...
      lesson1: [
        { foreign: 'la frente', english: 'the forehead', workingOn: true },
        { foreign: 'la ceja', english: 'the eyebrow', workingOn: true },
        { foreign: 'la oreja', english: 'the ear', workingOn: true },
        { foreign: 'el ojo', english: 'the eye', workingOn: true },
        { foreign: 'la mejilla', english: 'the cheek', hard: true, workingOn: true },
        { foreign: 'la boca', english: 'the mouth', workingOn: true },
        { foreign: 'la nariz', english: 'the nose', workingOn: true },
        { foreign: 'los dientes', english: 'the teeth', workingOn: true },
        { foreign: 'el labio', english: 'the lip', workingOn: true },
        { foreign: 'la lengua', english: 'the tongue', workingOn: true },
        { foreign: 'la garganta', english: 'the throat', workingOn: true },
        { foreign: 'el pecho', english: 'the chest', workingOn: true },
        { foreign: 'el brazo', english: 'the arm', workingOn: true },
        { foreign: 'el estómago', english: 'the stomach', workingOn: true },
        { foreign: 'la muñeca', english: 'the wrist', hard: true, workingOn: true },
      ],
      lesson2: [
        { foreign: 'el ombligo', english: 'the navel / belly button', workingOn: true },
        { foreign: 'el muslo', english: 'the thigh', workingOn: true },
        { foreign: 'la rodilla', english: 'the knee', workingOn: true },
        { foreign: 'el tobillo', english: 'the ankle', hard: true, workingOn: true },
        { foreign: 'los dedos de los pies / del pie', english: 'the toes', workingOn: true },
        { foreign: 'los dedos', english: 'the fingers', workingOn: true },
        { foreign: 'el pie', english: 'the foot', workingOn: true },
        { foreign: 'el cabello / el pelo', english: 'the hair', workingOn: true },
        { foreign: 'el hombro', english: 'the shoulder', workingOn: true },
        { foreign: 'el cuello', english: 'the neck', workingOn: true },
