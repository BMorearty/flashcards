  ...
  custom: {
    ...
    chapter24: {
      ...
      lesson7: [
        ...
        { foreign: 'Será divertido.', english: 'It will be fun.', workingOn: true },
      ],
      lesson8: [
        { foreign: 'conmigo', english: 'with me', workingOn: true },
        { foreign: 'contigo', english: 'with you (informal)', workingOn: true },
        { foreign: 'la boda', english: 'the wedding', workingOn: true },
        { foreign: 'bloqueador solar / protector solar', english: 'sunscreen', workingOn: true },
        { foreign: 'colores chillones', english: 'bright (loud) colors', workingOn: true },
        { foreign: 'me pongo', english: 'I put on (present tense)', workingOn: true },
        { foreign: 'pantuflas / zapatillas', english: 'slippers', workingOn: true },
      ...
      lesson9: [
        ...
        { foreign: 'nadie', english: 'nobody / no one', workingOn: true },
        { foreign: 'nada', english: 'nothing', workingOn: true },
        { foreign: 'en ningún lugar / ninguna parte', english: 'nowhere', workingOn: true },
      ],
    },
    chapter25: {
    ...
    chapter26: {
      ...
      lesson2: [
        ...
        { foreign: 'el traje de baño / el bañador', english: 'the swimsuit', workingOn: true },
        {
      ...
      lesson3: [
        ...
        { foreign: 'chaleco', english: 'vest', workingOn: true },
        { foreign: 'mochila', english: 'backpack', hard: true, workingOn: true },
        { foreign: 'las bragas', english: 'the panties', workingOn: true },
        { foreign: 'sujetador', english: 'bra', hard: true, workingOn: true },
        { foreign: 'un bastón', english: 'a cane', workingOn: true },
        {
          foreign: 'Lleva puestos unos vaqueros azules. (lleva puestos == lleva)',
    ...
    chapter27: {
      ...
      lesson1: [
        { foreign: 'ser blanco / blanca', english: 'to be white (person)', workingOn: true },
        {
          foreign: 'ser moreno / morena',
          english: 'to be black or brown-skinned (person)',
          workingOn: true,
        },
        { foreign: 'ser rubio / rubia', english: 'to be blond / blonde', workingOn: true },
        { foreign: 'ser pelirrojo / pelirroja', english: 'to be a redhead', workingOn: true },
        { foreign: 'ser joven', english: 'to be young', workingOn: true },
        { foreign: 'ser mayor', english: 'to be old', workingOn: true },
        { foreign: 'ser gordo / gorda', english: 'to be fat', workingOn: true },
        { foreign: 'ser gordito / gordita', english: 'to be chubby', workingOn: true },
        { foreign: 'ser delgado / delgada', english: 'to be thin', workingOn: true },
        { foreign: 'ser alto / alta', english: 'to be tall', workingOn: true },
        { foreign: 'ser bajo / baja', english: 'to be short (a person)', workingOn: true },
        { foreign: 'ser calvo / calva', english: 'to be bald', workingOn: true },
      ],
      lesson2: [
        { foreign: 'tener los ojos azules', english: 'to be blue-eyed', workingOn: true },
        { foreign: 'tener los ojos verdes', english: 'to be green-eyed', workingOn: true },
        { foreign: 'tener los ojos marrones', english: 'to be brown-eyed', workingOn: true },
        { foreign: 'tener los ojos negros', english: 'to be black-eyed', workingOn: true },
        ...
        { foreign: 'tener el cabello corto', english: 'to have short hair', workingOn: true },
        { foreign: 'tener el cabello largo', english: 'to have long hair', workingOn: true },
        { foreign: 'tener el cabello negro', english: 'to have black hair', workingOn: true },
        { foreign: 'tener el cabello castaño', english: 'to have brown hair', workingOn: true },
        { foreign: 'tener el cabello rubio', english: 'to have blond hair', workingOn: true },
        { foreign: 'tener el cabello rojo', english: 'to have red hair', workingOn: true },
        {
        ...
        { foreign: 'tener el cabello ondulado', english: 'to have wavy hair', workingOn: true },
        { foreign: 'tener el cabello liso', english: 'to have straight hair', workingOn: true },
      ],
      lesson3: [
        { foreign: 'tener / usar / llevar barba', english: 'to have a beard', workingOn: true },
        {
          foreign: 'tener / usar / llevar bigotes',
          english: 'to have a mustache',
          workingOn: true,
        },
        {
          foreign: 'tener / usar / llevar - lentes / gafas',
          english: 'to wear glasses',
          workingOn: true,
        },
        { foreign: 'tener / usar / llevar moño', english: 'to wear a bun', workingOn: true },
        {
