  ...
  custom: {
    chapter1: {
      ...
      lesson4: [
        ...
        { foreign: 'travieso', english: 'mischievous', workingOn: true, hard: true },
    ...
    chapter4: {
      ...
      lesson4: [
        ...
        { foreign: 'el cepillo', english: 'the brush', workingOn: true, hard: true },
      ...
      lesson7: [
        ...
        { foreign: 'el hada', english: 'the fairy', workingOn: true, hard: true },
    ...
    chapter9: {
      ...
      lesson1: [
        ...
        { foreign: 'la amistad', english: 'the friendship', workingOn: true, hard: true },
    ...
    chapter19: {
      ...
      lesson1: [
        ...
        { foreign: 'casado / casada', english: 'married', workingOn: true, hard: true },
    ...
    chapter24: {
      ...
      lesson2: [
        ...
        { foreign: 'vigilancia masiva', english: 'mass surveillance', workingOn: true, hard: true },
      ...
      lesson4: [
        ...
        { foreign: 'agarrar', english: 'to grab', workingOn: true, hard: true },
        ...
        { foreign: 'pastillas', english: 'pills' },
    ...
    chapter25: {
      ...
      lesson1: [
        ...
        { foreign: 'la ceja', english: 'the eyebrow' },
        { foreign: 'la oreja', english: 'the ear' },
        { foreign: 'el ojo', english: 'the eye' },
        { foreign: 'la mejilla', english: 'the cheek', workingOn: true, hard: true },
      ...
      lesson2: [
        ...
        { foreign: 'el tobillo', english: 'the ankle', workingOn: true, hard: true },
    ...
    chapter26: {
      ...
      lesson3: [
        ...
        { foreign: 'mochila', english: 'backpack', workingOn: true, hard: true },
    ...
    chapter29: {
      ...
      lesson4: [
        {
          foreign: 'estabas congelado/a',
          english: 'you were frozen (on screen) (informal)',
          workingOn: true,
        },
        ...
        { foreign: '¡Eso apesta!', english: 'That sucks!', workingOn: true },
        { foreign: 'una tos persistente', english: 'a lingering cough', workingOn: true },
        {
      ...
      lesson5: [
        ...
        { foreign: '¿Cómo luce ella?', english: 'What does she look like?', workingOn: true },
        {
          foreign: '...no es lo mismo que...',
          english: '...is not the same as...',
          workingOn: true,
        },
        {
    ...
    chapter30: {
      ...
      lesson1: [
        { foreign: 'Los veo.', english: 'I see them.', workingOn: true },
        { foreign: 'El Polo Norte', english: 'The North Pole', workingOn: true },
        {
        ...
        { foreign: 'el único', english: 'the only one', workingOn: true },
        {
          ...
          english: 'an endless number of surprises',
          workingOn: true,
        },
        {
          foreign: 'villas esparcidas aquí y allá',
          english: 'villas scattered here and there',
          workingOn: true,
        },
        {
        ...
        { foreign: 'cascos amurallados', english: 'walled historic centers', workingOn: true },
        { foreign: 'casco central', english: 'downtown', workingOn: true },
        { foreign: 'envidiable', english: 'enviable', workingOn: true },
        {
          foreign: 'negocios pequeños y encantadores',
