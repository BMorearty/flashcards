...
export const allPhrases = {
  custom: {
    chapter1: {
      ...
      lesson3: [
        { foreign: 'ayer', english: 'yesterday', working_on: true },
        { foreign: '¿Por qué?', english: 'Why?', working_on: true },
        { foreign: 'porque', english: 'because', working_on: true },
        { foreign: 'cuántos/cuántas', english: 'how many', working_on: true },
        { foreign: 'una hora', english: 'an hour', working_on: true },
        { foreign: 'sueño', english: 'sleep (n.)', working_on: true },
        { foreign: 'divertido', english: 'fun (adj.)', working_on: true },
        { foreign: 'más', english: 'more', working_on: true },
      ],
    },
    chapter2: {
