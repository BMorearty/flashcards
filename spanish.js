  ...
  random: {
    ...
    chapter5: {
      ...
      lesson3: [
        ...
        { foreign: 'capucha', english: 'hood', workingOn: true },
        { foreign: 'grados Fahrenheit', english: 'degrees Fahrenheit', workingOn: true },
        { foreign: 'pestañeo / pestañazo', english: 'blinking power / brownout', workingOn: true },
        { foreign: 'No tiene sentido.', english: 'It doesn’t make sense.', workingOn: true },
        { foreign: 'detalles', english: 'details', workingOn: true },
        ...
        { foreign: 'cebollas', english: 'onions', workingOn: true },
        ...
        { foreign: 'cortar', english: 'to cut', workingOn: true },
        {
          ...
          english: 'better than I thought possible',
          workingOn: true,
        },
        {
