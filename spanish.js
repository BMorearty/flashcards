  ...
  custom: {
    ...
    chapter19: {
      ...
      lesson1: [
        ...
        { foreign: 'finalmente', english: 'finally', workingOn: true },
        { foreign: 'ingeniero', english: 'engineer', workingOn: true },
        ...
        { foreign: 'Mucho gusto.', english: 'Nice to meet you.', workingOn: true },
        { foreign: 'casado / casada', english: 'married', workingOn: true },
        { foreign: 'un colega / una colega', english: 'a colleague', workingOn: true },
        {
          foreign: 'un compañero / una compañera',
          english: 'a partner / companion',
          workingOn: true,
        },
        { foreign: 'un conocido / una conocida', english: 'an acquaintance', workingOn: true },
        { foreign: 'hija', english: 'daughter', workingOn: true },
        { foreign: 'hijo', english: 'son', workingOn: true },
        { foreign: 'madre', english: 'mother', workingOn: true },
        { foreign: 'padre', english: 'father', workingOn: true },
        ...
        { foreign: 'primo / prima', english: 'cousin', workingOn: true },
