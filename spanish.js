  ...
  custom: {
    chapter1: {
      ...
      lesson1: [
        ...
        { foreign: 'ambos / ambas', english: 'both', hard: true, working_on: true },
      ...
      lesson6: [
        ...
        { foreign: 'desayunar', english: 'to have breakfast', working_on: true, hard: true },
    ...
    chapter11: {
      ...
      lesson1: [
        { foreign: 'nacionalidad', english: 'nationality', working_on: true },
        { foreign: 'árabe', english: 'Arab', working_on: true },
        { foreign: 'argentino / argentina', english: 'Argentinian', working_on: true },
        { foreign: 'australiano / australiana', english: 'Australian', working_on: true },
        { foreign: 'boliviano / boliviana', english: 'Bolivian', working_on: true },
        { foreign: 'brasileño / brasileña', english: 'Brazilian', working_on: true },
        { foreign: 'chileno / chilena', english: 'Chilean', working_on: true },
        { foreign: 'chino / china', english: 'Chinese', working_on: true },
        { foreign: 'colombiano / colombiana', english: 'Colombian', working_on: true },
        { foreign: 'costarricense (kohstahrreeSEHNseh)', english: 'Costa Rican', working_on: true },
        { foreign: 'cubano / cubana', english: 'Cuban', working_on: true },
        { foreign: 'ecuatoriano / ecuatoriana', english: 'Ecuadorean', working_on: true },
        { foreign: 'salvadoreño / salvadoreña', english: 'El Salvadorian', working_on: true },
        { foreign: 'español / española', english: 'Spanish', working_on: true },
        {
          foreign: 'europeo / europea (ehwrohPEHoh /ehwrohPEHah)',
          english: 'European',
          working_on: true,
        },
        { foreign: 'británico / británica', english: 'British', working_on: true },
        {
          foreign: 'guatemalteco / guatemalteca (gwahtehmahlTEHkoh / gwahtehmahlTEHkah)',
          english: 'Guatemalan',
          working_on: true,
        },
        { foreign: 'hondureño / hondureña', english: 'Honduran', working_on: true },
        { foreign: 'japonés / japonesa', english: 'Japanese', working_on: true },
        { foreign: 'nicaragüense', english: 'Nicaraguan', working_on: true },
        { foreign: 'panameño / panameña', english: 'Panamanian', working_on: true },
        {
          foreign: 'paraguayo / paraguaya (pahrahGWAHyoh / pahrahGWAHyah)',
          english: 'Paraguayan',
          working_on: true,
        },
        { foreign: 'peruano / peruana', english: 'Peruvian', working_on: true },
        { foreign: 'portugués / portuguesa', english: 'Portuguese', working_on: true },
        { foreign: 'puertorriqueño / puertorriqueña', english: 'Puerto Rican', working_on: true },
        { foreign: 'dominicano / dominicana', english: 'Dominican', working_on: true },
        { foreign: 'ruso / rusa', english: 'Russian', working_on: true },
        { foreign: 'turco / turca', english: 'Turkish', working_on: true },
        { foreign: 'uruguayo / uruguaya', english: 'Uruguayan', working_on: true },
        { foreign: 'venezolano / venezolana', english: 'Venezuelan', working_on: true },
        { foreign: 'maltés / maltesa', english: 'Maltese', working_on: true },
        { foreign: 'irlandés / irlandesa', english: 'Irish', working_on: true },
        { foreign: 'alemán / alemana', english: 'German', working_on: true },
        { foreign: 'francés / francesa', english: 'French', working_on: true },
      ],
    },
  },
  genders: {
  ...
  unit1: {
    ...
    chapter2: {
      ...
      lesson7: [
        ...
        { foreign: 'clase', english: 'class', working_on: true },
        { foreign: 'con fluidez', english: 'fluently', working_on: true },
      ],
    },
  },
};
