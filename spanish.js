...
export const allPhrases = {
  custom: {
    ...
    chapter13: {
      ...
      lesson2: [
        { foreign: 'país', english: 'country', workingOn: true },
        { foreign: 'Francia', english: 'France', workingOn: true },
        { foreign: 'Gran Bretaña', english: 'Great Britain', workingOn: true },
        { foreign: 'Inglaterra', english: 'England', workingOn: true },
        { foreign: 'Reino Unido', english: 'United Kingdom', workingOn: true },
        { foreign: 'Rusia', english: 'Russia', workingOn: true },
        { foreign: 'Turquía', english: 'Turkey', workingOn: true },
      ],
      lesson3: [
        { foreign: 'chino', english: 'Chinese (language)' },
        { foreign: 'criollo', english: 'creole (language)', workingOn: true },
    ...
    chapter14: {
      ...
      lesson1: [
        ...
        { foreign: '¡Claro!', english: 'Of course!', workingOn: true },
        { foreign: 'Lo siento.', english: 'I’m sorry.', workingOn: true },
        { foreign: 'No mucho.', english: 'Not much.', workingOn: true },
