  ...
  custom: {
    ...
    chapter3: {
      ...
      lesson1: [
        ...
        { foreign: 'Hace mucho frío.', english: 'It is freezing.', working_on: true },
      ],
    },
    chapter4: {
      ...
      lesson1: [
        ...
        { foreign: 'la yegua', english: 'the mare', working_on: true },
        { foreign: 'la gallina', english: 'the hen', working_on: true },
        { foreign: 'el yoga', english: 'the yoga', working_on: true },
        { foreign: 'la lluvia', english: 'the rain', working_on: true },
        { foreign: 'la galleta', english: 'the cookie', working_on: true },
        { foreign: 'el yate', english: 'the yacht', working_on: true },
      ],
      lesson2: [
        { foreign: 'la bañera', english: 'the bathtub', working_on: true },
        { foreign: 'el vestido', english: 'the dress', working_on: true },
        { foreign: 'el virus', english: 'the virus', working_on: true },
        { foreign: 'la botella', english: 'the bottle', working_on: true },
      ...
      lesson4: [
        ...
        { foreign: 'el semáforo', english: 'the traffic light', working_on: true },
        ...
        { foreign: 'el zorro', english: 'the fox', working_on: true },
      ],
      lesson5: [
        { foreign: 'el jabón', english: 'the soap', working_on: true },
        { foreign: 'el traje', english: 'the suit', working_on: true },
        { foreign: 'la gente', english: 'the people', working_on: true },
        { foreign: 'el/la jirafa', english: 'the giraffe', working_on: true },
        { foreign: 'el gimnasio', english: 'the gym', working_on: true },
        { foreign: 'el ojo', english: 'the eye', working_on: true },
        { foreign: 'el jugo', english: 'the juice', working_on: true },
      ],
      lesson6: [
        { foreign: 'el garaje', english: 'the garage', working_on: true },
        ...
        { foreign: 'el gusano', english: 'the worm', working_on: true },
      ],
      lesson7: [
        { foreign: 'el hacha', english: 'the axe', working_on: true },
        { foreign: 'el helado', english: 'the ice cream', working_on: true },
        { foreign: 'el hilo', english: 'the thread', working_on: true },
        { foreign: 'el hueso', english: 'the bone', working_on: true },
  ...
  genders: {
    ...
    chapter2: {
      ...
      lesson1: [
        ...
        { foreign: 'el clima', english: 'the weather' },
        ...
        { foreign: 'el esta', english: 'the east' },
        { foreign: 'el oeste', english: 'the west' },
        ...
        { foreign: 'el planeta', english: 'the planet', hard: true },
        { foreign: 'la calle', english: 'the street', hard: true },
        { foreign: 'el campo', english: 'the field' },
        ...
        { foreign: 'la cabeza', english: 'head' },
      ],
    },
  },
  unit1: {
