...
export const allPhrases = {
  custom: {
    chapter1: {
      ...
      lesson8: [
        { foreign: 'tomar café', english: 'to have coffee', workingOn: true },
        { foreign: 'a veces / algunas veces', english: 'sometimes', workingOn: true },
        { foreign: '¡Aja!', english: 'Aha!', workingOn: true },
        { foreign: '¡Guao!', english: 'Wow!', workingOn: true },
        { foreign: 'nunca antes', english: 'never before', workingOn: true },
        { foreign: 'olvidar', english: 'to forget', workingOn: true },
        {
          foreign: 'Un café por día / al día no es nada.',
          english: 'One coffee per day is nothing.',
          workingOn: true,
        },
        { foreign: 'una taza de café', english: 'a cup of coffee', workingOn: true },
        {
          foreign: 'Cuando tienes poca energía, el café te la da.',
          english: 'When you have low energy, coffee gives you some.',
          workingOn: true,
        },
        { foreign: 'un abrazo', english: 'a hug', workingOn: true },
        { foreign: 'un abrazote', english: 'a big hug', workingOn: true },
        { foreign: 'hispanos', english: 'hispanics', workingOn: true },
        { foreign: 'morenos', english: 'black people', workingOn: true },
        { foreign: '¡Chévere!', english: 'Cool!', workingOn: true },
        { foreign: 'mis papis', english: 'my parents', workingOn: true },
        { foreign: 'un pato', english: 'a duck', workingOn: true },
        { foreign: 'un patito', english: 'a duckling', workingOn: true },
        { foreign: 'un pez / algunos peces', english: 'a fish / some fish', workingOn: true },
        { foreign: 'dar un paseo', english: 'to go for a walk', workingOn: true },
        { foreign: 'Querido primo', english: 'Dear cousin (writing a letter)', workingOn: true },
      ],
    },
    chapter2: {
    ...
    chapter14: {
      ...
      lesson1: [
        ...
        { foreign: 'además', english: 'besides', workingOn: true, hard: true },
