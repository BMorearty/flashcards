  ...
  grammar: {
    ...
    chapter11: {
      ...
      lesson3: [
        ...
        { foreign: 'cepillarse el pelo / los dientes', english: 'to brush one’s hair / teeth' },
        { foreign: 'ducharse', english: 'to take a shower' },
        { foreign: 'bañarse', english: 'to bathe' },
        { foreign: 'lavarse', english: 'to wash yourself' },
        { foreign: 'secarse', english: 'to dry off' },
        { foreign: 'vestirse', english: 'to get dressed' },
        { foreign: 'peinarse', english: 'to comb one’s hair' },
        { foreign: 'afeitarse', english: 'to shave', hard: true },
        { foreign: 'maquillarse', english: 'to put on make up' },
        { foreign: 'acostarse', english: 'to go to bed' },
      ],
    },
    chapter12: {
  ...
  vocabulary: {
    ...
    chapter2: {
      ...
      lesson1: [
        ...
        { foreign: 'ventea', english: 'the wind is blowing' },
        { foreign: 'Hace buen tiempo.', english: 'It’s nice out.', workingOn: true },
        { foreign: 'Hace mal tiempo.', english: 'The weather is bad.' },
      ],
    },
    chapter3: {
      name: 'Seasons',
    ...
    chapter14: {
      ...
      lesson1: [
        ...
        { foreign: 'siempre', english: 'always' },
  ...
  random: {
    ...
    chapter2: {
      ...
      lesson2: [
        ...
        { foreign: 'matar', english: 'to kill', hard: true, workingOn: true },
    ...
    chapter4: {
      ...
      lesson8: [
        ...
        { foreign: 'despedir', english: 'to fire (someone)', hard: true },
        { foreign: 'la decisión más importante', english: 'the most important decision' },
        { foreign: 'enseñar', english: 'to teach', hard: true },
        ...
        { foreign: 'cesta de picnic', english: 'picnic basket' },
      ...
      lesson9: [
        ...
        { foreign: 'sumar y restar', english: 'adding and subtracting' },
    ...
    chapter5: {
      ...
      lesson2: [
        ...
        { foreign: 'suficiente', english: 'enough' },
        { foreign: 'un patrón', english: 'a pattern' },
        { foreign: 'bautismo', english: 'baptism' },
        { foreign: 'un emparedado / sándwich', english: 'a sandwich' },
      ...
      lesson3: [
        ...
        { foreign: 'capucha', english: 'hood (e.g. of a hoodie)', hard: true },
        ...
        { foreign: 'dibujar', english: 'to draw' },
        { foreign: 'una flor', english: 'a flower' },
        { foreign: 'tiras cómicas', english: 'comic strips', hard: true },
        { foreign: 'dibujos animados', english: 'animated cartoons' },
        { foreign: 'Es divertido.', english: 'It’s fun.' },
        { foreign: 'adivinar', english: 'to guess' },
        { foreign: 'cebolla', english: 'onion', hard: true },
        { foreign: 'ajo', english: 'garlic' },
        { foreign: 'cortar', english: 'to cut' },
        { foreign: 'mejor de lo que yo creía posible', english: 'better than I thought possible' },
        { foreign: 'Tengo hambre de conocimiento.', english: 'I’m hungry for knowledge.' },
      ],
      lesson4: [
        { foreign: 'desayuna cereales con leche', english: 'has cereal with milk for breakfast' },
        {
      ...
      lesson6: [
        ...
        { foreign: 'Termino de trabajar a las 5 p.m.', english: 'I finish work at 5 p.m.' },
        {
          ...
          english: 'He is teething,| so his teeth hurt| and he cries a little.',
        },
      ],
      lesson7: [
        {
        ...
        },
        {
          ...
          english: 'our own heads',
          hard: true,
          workingOn: true,
        },
        { foreign: 'agnóstico/a', english: 'agnostic', workingOn: true },
        { foreign: 'ateo/a', english: 'atheist', workingOn: true },
        ...
        {
          foreign: 'Me ducho tranquilamente mientras canto una canción de moda.',
          english: 'I take a shower at a leisurely pace while singing a popular song.',
          hard: true,
          workingOn: true,
        },
        { foreign: 'panquecas con miel', english: 'pancakes with honey', workingOn: true },
        {
          foreign: 'Había tantas opciones que no sabía cuál escoger.',
        ...
        {
          foreign: 'un restaurante que a ambas / a las dos nos encanta',
      ...
      lesson9: [
        ...
        { foreign: 'roer', english: 'to gnaw', workingOn: true },
        { foreign: 'dueño/a de mascota', english: 'pet owner', hard: true, workingOn: true },
        { foreign: 'Tengo que recordar.', english: 'I have to remember.', workingOn: true },
        { foreign: 'un cuenco', english: 'a bowl', workingOn: true },
        { foreign: 'un consejo', english: 'a piece of advice', hard: true, workingOn: true },
        { foreign: 'Tengo una pareja.', english: 'I have a partner.', workingOn: true },
        { foreign: 'Somos pareja.', english: 'We are a couple.', workingOn: true },
        { foreign: 'cuidar la planta', english: 'to take care of the plant', workingOn: true },
        { foreign: 'sobrevivir', english: 'to survive', workingOn: true },
        {
          foreign: 'Me voy de fiesta.',
          english: 'I’m going out partying.',
          hard: true,
          workingOn: true,
        },
        { foreign: 'Voy de fiesta.', english: 'I’m going to a party.', workingOn: true },
        { foreign: 'olor', english: 'odor', workingOn: true },
        { foreign: 'asesinar', english: 'to murder', workingOn: true },
        { foreign: 'autogol', english: 'own goal (soccer)', workingOn: true },
        { foreign: 'gracias a Dios', english: 'thankfully / fortunately', workingOn: true },
        { foreign: 'volverse', english: 'to become', hard: true, workingOn: true },
      ],
      lesson10: [
        { foreign: 'terremoto', english: 'earthquake', workingOn: true },
        {
          foreign: 'gran (before the noun; singular nouns only; masc or fem)',
          english: 'great or important',
          workingOn: true,
        },
        { foreign: 'un seguro', english: 'an insurance policy', workingOn: true },
        { foreign: 'los escombros', english: 'the rubble', hard: true, workingOn: true },
        { foreign: 'he oído', english: 'I have heard', workingOn: true },
        { foreign: 'daño', english: 'damage', hard: true, workingOn: true },
        {
          foreign: 'alimento',
          english: 'food (nourishment/nutrients)',
          hard: true,
          workingOn: true,
        },
        { foreign: 'comida', english: 'food/meal (casual)', workingOn: true },
        { foreign: 'Hace falta café.', english: 'I/we need coffee.', workingOn: true },
        {
          foreign: 'Me falta café. / Me hace falta café.',
          english: 'I need coffee. (emphasis)',
          workingOn: true,
        },
        { foreign: 'inundación(es)', english: 'flood(s)', workingOn: true },
        { foreign: 'el octavo piso', english: 'the eighth floor', hard: true, workingOn: true },
        { foreign: 'trabado/a', english: 'stuck', hard: true, workingOn: true },
        { foreign: 'toallas de papel', english: 'paper towels', workingOn: true },
        { foreign: 'secador de manos', english: 'hand dryer', workingOn: true },
        { foreign: 'cantidad', english: 'quantity', workingOn: true },
