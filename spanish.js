...
export const allPhrases = {
  custom: {
    ...
    chapter19: {
      name: 'Introductions',
      lesson1: [
        { foreign: 'enfermo', english: 'sick', workingOn: true },
        { foreign: 'finalmente', english: 'finally' },
        { foreign: 'ingeniero / ingeniera', english: 'engineer' },
        { foreign: 'voy a', english: 'I am going to', workingOn: true },
        {
        ...
        { foreign: 'casado / casada', english: 'married', workingOn: true },
        { foreign: 'un colega / una colega', english: 'a colleague', workingOn: true },
        {
        ...
        { foreign: 'Don', english: 'Sir', workingOn: true },
        { foreign: 'Doña', english: 'Madam', workingOn: true },
        { foreign: 'presentar', english: 'to introduce', workingOn: true },
        { foreign: 'primo / prima', english: 'cousin' },
        { foreign: 'soltero / soltera', english: 'bachelor / single woman', workingOn: true },
      ],
    },
    chapter20: {
      name: 'Professions',
      lesson1: [
        { foreign: 'abogado / abogada', english: 'lawyer', workingOn: true },
        { foreign: 'actor / actriz', english: 'actor / actress', workingOn: true },
        { foreign: 'arquitecto / arquitecta', english: 'architect', workingOn: true },
        { foreign: 'un artista / una artista', english: 'an artist', workingOn: true },
        { foreign: 'autor / autora', english: 'author', workingOn: true },
        { foreign: 'un cantante / una cantante', english: 'a singer', workingOn: true },
        { foreign: 'chef (pronounced like Chef Chu)', english: 'chef', workingOn: true },
        { foreign: 'científico / científica', english: 'scientist', workingOn: true },
        { foreign: 'conductor / conductora', english: 'driver', workingOn: true },
        { foreign: 'director / directora', english: 'director', workingOn: true },
        { foreign: 'doctor / doctora', english: 'doctor', workingOn: true },
        {
        ...
        { foreign: 'estudiante de secundaria', english: 'high school student', workingOn: true },
        {
        ...
        { foreign: 'mesero / mesera', english: 'waiter / waitress', workingOn: true },
        { foreign: 'ministro / ministra', english: '(religious) minister', workingOn: true },
