  ...
  custom: {
    chapter1: {
      ...
      lesson1: [
        ...
        { foreign: 'tiempo', english: 'weather' },
        {
        ...
        { foreign: 'hay', english: 'there is/there are', working_on: true },
        {
    ...
    chapter3: {
      ...
      lesson1: [
        ...
        { foreign: 'Está soleado.', english: 'It is sunny.', working_on: true },
        { foreign: 'Está ventoso.', english: 'It is windy.', working_on: true },
    ...
    chapter4: {
      ...
      lesson1: [
        { foreign: 'la llave', english: 'the key', working_on: true },
        { foreign: 'la yegua', english: 'the mare', working_on: true, hard: true },
        { foreign: 'la gallina', english: 'the hen', working_on: true },
        { foreign: 'el yoga', english: 'the yoga' },
        { foreign: 'la lluvia', english: 'the rain', working_on: true },
        { foreign: 'la galleta', english: 'the cookie' },
        { foreign: 'el yate', english: 'the yacht' },
      ],
      lesson2: [
        { foreign: 'la bañera', english: 'the bathtub', working_on: true },
        { foreign: 'el vestido', english: 'the dress' },
        { foreign: 'el virus', english: 'the virus' },
        { foreign: 'la botella', english: 'the bottle' },
        { foreign: 'la bufanda', english: 'the scarf', working_on: true },
        { foreign: 'la vaca', english: 'the cow' },
        { foreign: 'el/la bebé', english: 'the baby' },
      ],
      lesson3: [
        { foreign: 'la campana', english: 'the bell', working_on: true },
        { foreign: 'el queso', english: 'the cheese', working_on: true },
        { foreign: 'el kilo', english: 'the kilo' },
        { foreign: 'el conejo', english: 'the rabbit', working_on: true },
        { foreign: 'la cuchara', english: 'the spoon', working_on: true },
        { foreign: 'el kárate', english: 'the karate' },
        { foreign: 'la mantequilla', english: 'the butter', working_on: true },
      ],
      lesson4: [
        { foreign: 'el zapato', english: 'the shoe' },
        { foreign: 'el cepillo', english: 'the brush', working_on: true },
        { foreign: 'el semáforo', english: 'the traffic light' },
        { foreign: 'el zinc', english: 'the zinc' },
        { foreign: 'el cine', english: 'the cinema', working_on: true },
        { foreign: 'la silla', english: 'the chair', working_on: true },
        { foreign: 'el zorro', english: 'the fox' },
      ],
      lesson5: [
        { foreign: 'el jabón', english: 'the soap', working_on: true, hard: true },
      ...
      lesson6: [
        { foreign: 'el garaje', english: 'the garage', working_on: true, hard: true },
        { foreign: 'el guepardo', english: 'the cheetah', working_on: true },
        { foreign: 'la hamburguesa', english: 'the hamburger', working_on: true },
        { foreign: 'la guitarra', english: 'the guitar' },
        { foreign: 'el águila', english: 'the eagle', working_on: true },
        { foreign: 'la gorra', english: 'the cap', working_on: true },
        { foreign: 'el gusano', english: 'the worm', working_on: true, hard: true },
      ],
      lesson7: [
        { foreign: 'el hacha', english: 'the axe', working_on: true },
        { foreign: 'el helado', english: 'the ice cream' },
        { foreign: 'el hilo', english: 'the thread', working_on: true },
        { foreign: 'el hueso', english: 'the bone', working_on: true, hard: true },
        { foreign: 'el hada', english: 'the fairy', working_on: true },
        { foreign: 'la huella', english: 'the fingerprint', working_on: true },
      ],
    },
    chapter5: {
    ...
    chapter7: {
      ...
      lesson1: [
        ...
        { foreign: 'primavera', english: 'spring', working_on: true, hard: true },
  ...
  genders: {
    ...
    chapter2: {
      ...
      lesson1: [
        ...
        { foreign: 'la amistad', english: 'the friendship', working_on: true },
        { foreign: 'la pared', english: 'the wall', working_on: true },
        { foreign: 'la salud', english: 'the health', working_on: true },
        { foreign: 'la canción', english: 'the song', working_on: true },
        { foreign: 'la emoción', english: 'the emotion', working_on: true },
        { foreign: 'la situación', english: 'the situation', working_on: true },
        { foreign: 'la crisis', english: 'the crisis', working_on: true },
        { foreign: 'la tendonitis', english: 'the tendonitis', working_on: true },
        { foreign: 'la cruz', english: 'the cross' },
        { foreign: 'la nariz', english: 'the nose', working_on: true },
        { foreign: 'el lápiz', english: 'the pencil', working_on: true },
        { foreign: 'el arroz', english: 'the rice', working_on: true },
        { foreign: 'la a', english: 'the a', working_on: true },
        { foreign: 'la b', english: 'the b' },
        { foreign: 'la c', english: 'the c' },
        { foreign: 'el banco', english: 'the bank', working_on: true },
        { foreign: 'la mano', english: 'the hand', working_on: true },
        { foreign: 'la foto', english: 'the photo', working_on: true },
        { foreign: 'el titular', english: 'the owner', working_on: true },
        { foreign: 'el computador/la computadora', english: 'the computer' },
        { foreign: 'el taller', english: 'the shop', working_on: true },
        { foreign: 'la flor', english: 'the flower', working_on: true },
        { foreign: 'el clima', english: 'the weather', working_on: true, hard: true },
        { foreign: 'el problema', english: 'the problem', working_on: true },
        { foreign: 'el sistema', english: 'the system', working_on: true },
        { foreign: 'el rey', english: 'the king', working_on: true },
        { foreign: 'el buey', english: 'the ox', working_on: true },
        { foreign: 'la ley', english: 'the law', working_on: true },
        { foreign: 'el tórax', english: 'the thorax', working_on: true },
        ...
        { foreign: 'el esta', english: 'the east', working_on: true },
        { foreign: 'el oeste', english: 'the west', working_on: true },
        { foreign: 'el enero', english: 'the January', working_on: true },
        { foreign: 'el febrero', english: 'the February', working_on: true },
        ...
        { foreign: 'el sofá', english: 'the sofa', working_on: true },
        { foreign: 'el planeta', english: 'the planet', working_on: true, hard: true },
        { foreign: 'la calle', english: 'the street', working_on: true, hard: true },
        { foreign: 'el campo', english: 'the field', working_on: true, hard: true },
        { foreign: 'el/la policia', english: 'the police officer', working_on: true },
        { foreign: 'el ordenador', english: 'the computer (like the French word)' },
        { foreign: 'la tristeza', english: 'sadness' },
        { foreign: 'la cabeza', english: 'head', working_on: true },
      ],
    },
  },
  unit1: {
